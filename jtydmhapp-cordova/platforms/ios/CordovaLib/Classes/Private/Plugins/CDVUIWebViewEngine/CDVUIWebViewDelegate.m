...
{
    NSString *appFontSizeTag = [[NSUserDefaults standardUserDefaults] valueForKey:@"kAppFontSizeTagKey"];
//    NSLog(@"设置 UIWebView 字体版本 %@", appFontSizeTag);
    NSString *fontsizeStr = @"100%";
    if (appFontSizeTag && [appFontSizeTag isEqualToString:@"larger"]) {
        fontsizeStr = @"130%";
    }
    [UIApplication sharedApplication].networkActivityIndicatorVisible = NO;
    [webView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"document.getElementsByTagName('body')[0].style.webkitTextSizeAdjust= '%@'", fontsizeStr]];
