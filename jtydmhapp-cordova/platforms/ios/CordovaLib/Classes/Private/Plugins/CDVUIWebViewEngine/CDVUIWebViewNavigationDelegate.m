...
- (void)webView:(UIWebView*)theWebView didFailLoadWithError:(NSError*)error
{
    ...
    if (errorUrl) {
        ...
        // add by TP
        [[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:CDVPageDidLoadFailedNotification object:self.enginePlugin.webView]];
    }
}
