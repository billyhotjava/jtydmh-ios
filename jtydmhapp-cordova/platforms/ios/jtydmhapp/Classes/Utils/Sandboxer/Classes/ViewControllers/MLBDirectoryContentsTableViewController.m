...
@interface MLBDirectoryContentsTableViewController () <QLPreviewControllerDataSource, UIViewControllerPreviewingDelegate, UISearchResultsUpdating, UISearchBarDelegate, UISearchControllerDelegate, UIAlertViewDelegate, UITableViewDelegate, UITableViewDataSource>
...
- (void)setupViews {
    ...
    [self.view bringSubviewToFront:waterMaskView];
}
...
//
//            CLPreviewController *previewController = [[CLPreviewController alloc] init];
