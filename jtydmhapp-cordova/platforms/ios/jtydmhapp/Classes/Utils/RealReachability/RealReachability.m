...
- (void)startNotifier
{
    ...
    NSLog(@"%s %d, %@", __FUNCTION__, __LINE__, _hostForPing);
    self.pingHelper.timeout = self.pingTimeout;
    
    self.pingChecker.host = _hostForCheck;
    NSLog(@"%s %d, %@", __FUNCTION__, __LINE__, _hostForCheck);
...
- (void)setHostForPing:(NSString *)hostForPing
{
    ...
    NSLog(@"%s %d, %@", __FUNCTION__, __LINE__, hostForPing);
    self.pingHelper.host = _hostForPing;
}
...
- (void)setHostForCheck:(NSString *)hostForCheck
{
    ...
    NSLog(@"%s %d, %@", __FUNCTION__, __LINE__, hostForCheck);
    self.pingChecker.host = _hostForCheck;
}
