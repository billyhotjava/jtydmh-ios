...
//        [self.webView setFrame:CGRectMake(self.webView.frame.origin.x, TOOLBAR_HEIGHT, self.webView.frame.size.width, self.webView.frame.size.height)];
        // add by TP
        [self.webView setFrame:CGRectMake(self.webView.frame.origin.x, CGRectGetMinY(self.webView.frame) + TOOLBAR_HEIGHT, self.webView.frame.size.width, self.webView.frame.size.height)];
