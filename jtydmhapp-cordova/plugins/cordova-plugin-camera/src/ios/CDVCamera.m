...
- (UIImage*)retrieveImage:(NSDictionary*)info options:(CDVPictureOptions*)options
{
    ...
    if (image) {
        // 添加水印
        CGFloat x = image.size.width - 1200;
        CGFloat y = image.size.height - 600;
        targetImage = [image imageWaterMarkWithRect:CGRectMake(x, y, 1800, 500) attribute:@{NSFontAttributeName: [UIFont systemFontOfSize:200], NSForegroundColorAttributeName: [UIColor whiteColor]}];
//        targetImage = [targetImage rotatedByImageOrientation:image.imageOrientation];
    }
    ...
    if (scaledImage) {
        // 添加水印
        CGFloat x = scaledImage.size.width - 1200;
        CGFloat y = scaledImage.size.height - 600;
        targetImage = [scaledImage imageWaterMarkWithRect:CGRectMake(x, y, 1800, 500) attribute:@{NSFontAttributeName: [UIFont systemFontOfSize:200], NSForegroundColorAttributeName: [UIColor whiteColor]}];
//        targetImage = [targetImage rotatedByImageOrientation:scaledImage.imageOrientation];
    }
