...
- (void)pushImagePickerController {
    ...
    if ([UIImagePickerController isSourceTypeAvailable: sourceType]) {
        ...
        if (tzImagePickerVc.allowTakeVideo) {
            ...
            self.imagePickerVc.videoMaximumDuration = tzImagePickerVc.videoMaximumDuration - 1.0;
        }
...
- (void)imagePickerController:(UIImagePickerController*)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
    ...
    if ([type isEqualToString:@"public.image"]) {
        ...
        // 添加水印
//        CGFloat x = photo.size.width - 1200;
//        CGFloat y = photo.size.height - 600;
//        UIImage *targetImage = [photo imageWaterMarkWithRect:CGRectMake(x, y, 1800, 500) attribute:@{NSFontAttributeName: [UIFont systemFontOfSize:200], NSForegroundColorAttributeName: [UIColor whiteColor]}];
//        targetImage = [targetImage rotatedByImageOrientation:photo.imageOrientation];
